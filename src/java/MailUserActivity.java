 ...
 * @author Murugappan
 */
public class MailUserActivity extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MailUserActivity</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MailUserActivity at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       // String umailid=request.getParameter("email");
        ...
        String umailid="mnachi21@uic.edu";
        ...
        print1.print("<h3>");
       print1.print("E-mail has been sent to your registered mail id : "+umailid+"\nTest Data: "+mailbody);
       print1.print("</h3>");
